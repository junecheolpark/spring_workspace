...
<body>
    ...
    <div id="subBox" class="row" style="height: 1080px;">
        <article id="subLeft" class="text-center px-0">
        ...
        <article id="subRight" class="col">
            <table class="table mb-0">
                ...
                <tbody>
                    <tr>
                        <th>제목</th>
                        <td><input name="SUBJ" type="text" class="w-100" value=""></td>
                    </tr>
                    <tr>
                        <th>작성자</th>
                        <!--REG_NM-->
                    ...
                    <tr>
                        <th>내용</th>
                        <!--CONTS-->
                        <td><textarea name="CONTS" id="conts" class="w-100" style="height: 400px;" value=""></textarea></td>
